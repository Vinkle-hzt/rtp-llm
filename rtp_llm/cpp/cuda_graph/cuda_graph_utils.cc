...
void debugPrintPyModelInputs(const torch_ext::PyModelInputs& inputs) {
    ...
    std::cout << "  max_sequence_length: " << inputs.attention_inputs.max_sequence_length << std::endl;

    printTensorInfo("prefix_lengths", inputs.attention_inputs.prefix_lengths);
    printTensorInfo("sequence_lengths_host", inputs.attention_inputs.sequence_lengths_host);
    printTensorInfo("sequence_lengths_device", inputs.attention_inputs.sequence_lengths_device);
