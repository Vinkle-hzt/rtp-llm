...
void tpSyncModelInputs(GptModelInputs& inputs, const ParallelismConfig& parallelism_config) {
    ...
    shape_hints_ptr[GptModelInputIndex::maxSequenceLength] = inputs.max_sequence_length;
    ...
    inputs.max_sequence_length             = shape_hints_ptr[GptModelInputIndex::maxSequenceLength];
    if (inputs.skip_run) {
        return;
    }
