...
public:
    ...
    absl::Status step();
    // Phase 3.2: async-scheduling entry point. When use_async_scheduling_ is
...
private:
    // Phase 3.2: drives the result-thread bookkeeping loop. Started lazily
...
private:
    ...
    // Phase 3.2 async scheduling state. All scaffolding; the synchronous
