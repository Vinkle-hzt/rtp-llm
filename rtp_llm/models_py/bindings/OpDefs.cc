...
void registerPyOpDefs(pybind11::module& m) {
    ...
    pybind11::class_<PyAttentionInputs>(m, "PyAttentionInputs")
        ...
        .def_readwrite("disable_flash_infer", &PyAttentionInputs::disable_flash_infer)
        ...
        .def_readwrite("sequence_lengths_device", &PyAttentionInputs::sequence_lengths_device)
        .def_readwrite("max_sequence_length", &PyAttentionInputs::max_sequence_length)
