...
// cudaDeviceSynchronize stall . When the broadcaster has not been
// initialized — e.g. cross-node TP, or single-rank — falls back to
// execBroadcast (the original NCCL path with cudaSyncAndCheck) so callers
